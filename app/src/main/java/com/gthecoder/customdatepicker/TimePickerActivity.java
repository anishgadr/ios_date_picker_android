package com.gthecoder.customdatepicker;
...
import com.gthecoder.customdatepicker.DateTimeWheel.DateWheel.LoopListener;
import com.gthecoder.customdatepicker.DateTimeWheel.DateWheel.LoopView;
...
public class TimePickerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void initialiseTimeWheel() {
        ...
        hourLoopView = findViewById(R.id.picker_hour);
        minLoopView = findViewById(R.id.picker_min);
        secLoopView =  findViewById(R.id.picker_sec);
        timeMeridiemView = findViewById(R.id.picker_meridiem);
